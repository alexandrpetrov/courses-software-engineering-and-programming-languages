...
int main(void) {
    int adjustments[] = {40, 35, -20, 60, -90, 25};
...
PROCESS_STEP:
    ...
    if (proposed < 50) goto CLAMP_LOW;
    if (proposed > 220) goto CLAMP_HIGH;
    value = proposed;
    goto CHECK_ALERT;
...
FINISH:
    printf("Final oven temperature: %d.\n", value);
